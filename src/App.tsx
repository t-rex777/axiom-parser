...
function App() {
  ...
  return (
    <div className="popup-container">
      ...
      <button className="parse-button" onClick={handleManualParse} type="button">
        Parse Now
      </button>

      {status && <div className={`status ${status.includes("success") ? "success" : ""}`}>{status}</div>}
    </div>
  );
}
